<div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div class=" inline-flex col-span-7 p-3 w-full">
            ...
            {{-- end button --}}
                @if ($open_modal)
                    @include('livewire.data_pakar.create')
                @endif
                ...
                @endif
                @if (!$cari_data_pakar)
                    @include('livewire.data_pakar.cari_data_pakar')
                @endif
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            @forelse ($all_data_pakar as $kecanduan)
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <button  wire:click="detailDataPakar( {{ $kecanduan->id }} )" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                                Detail
                            </button>
