        ...
        <div class="flex items-end justify-center max-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div
                class="inline-block align-bottom bg-white
                        ...
                        transition-all sm:my-8 sm:align-middle w-10/12"
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div class="mb-2 w-full inline">
                    <table class="w-full text-sm rounded text-left text-gray-400">
                        ...
                        <tbody>
                            @foreach ($select_kecanduan as $index => $kecanduan)
                                <tr class="bg-white w-auto">
                                    {{-- select kecanduan_id --}}
                                    <td class="px-1 py-6">
                                        <select wire:model="kecanduan.{{ $index }}"
                                            ...
                                            <option value="">-- Pilih Keterangan Kecanduan --</option>
                                                @forelse ($all_kecanduan as $kecanduan)
                                                    <option
                                                        class="font-normal hover:font-bold border-gray-300 rounded-lg capitalize"
                                                        value="{{ $kecanduan->id }}">  {{ $kecanduan->level->keterangan ?? '' }} | {{ $kecanduan->deskripsi }}
                                                    </option>
                                                @empty
                                        ...
                                        {{-- <td class="bg-blue-200">
                                            <select wire:model="kecanduan.{{ $index }}"
                                                    class="border border-gray-300 text-gray-900 text-sm
                                                    rounded-lg focus:ring-blue-500 focus:border-blue-500
                                                    w-8/12 bg-white dark:border-gray-600
                                                    dark:placeholder-gray-400
                                                    font-semibold dark:focus:ring-blue-500
                                                    dark:focus:border-blue-500"
                                                    name="" id="">
                                                <option value="">-- Pilih Keterangan Kecanduan --</option>
                                                @forelse ($all_kecanduan as $item)
                                                    <option
                                                        class="font-normal hover:font-bold border-gray-300 rounded-lg capitalize"
