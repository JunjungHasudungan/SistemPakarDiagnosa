                        ...
                        <div class="mb-6">
                            ...
                            <select wire:model="kecanduan_id"
                                          ...
                                          <option value="">-- Pilih Keterangan Kecanduan --</option>
                                              @forelse ($all_data_pakar as $item)
                                                  <option class="font-normal hover:font-bold border-gray-300 rounded-lg capitalize" value="{{$item->id}}">  {{ $item->level->keterangan }} | {{ $item->deskripsi }} </option>
                                              @empty
                                                  <option class="font-normal bg-yellow-400 hover:font-bold capitalize">Keterangan Kecanduan Belum Tersedia..</option>
                                              @endforelse
                            </select>
